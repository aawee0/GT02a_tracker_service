...
{
    public class Gt02Handler : IDeviceHandler
    {
        ...
        public void Init(System.Xml.XmlElement handlerElement)
        {
            ...
            serverClient.WireProtocolFactory = new Protocols.Gt02WireProtocolFactory();
        ...
        {
            logger.Debug("gt02 sent: " + e.Message.ToString());
        }
    }
}
